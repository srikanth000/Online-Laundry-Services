...
{
%>
<h1 align="center" style="font-size: 22px; text-decoration: underline; text-transform: uppercase;"> Order / Pickup Receipt </h1>
<h2 align="right">Pickup Time : &nbsp; <%=rs.getString("picuptime")%></h2>
...
<p> Note : This is electronic generated receipt. There are no need for seel & signature's.</p>
<br/>
