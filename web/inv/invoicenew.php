...
header("location:../printinvoice.php?id=$cus_id");
}
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div id="header">
           ...
           <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a href="../welcomestores.php">Dashboard</a></li>
                            <li><a href="invoice.php">Add Custumer</a></li>
                            <li><a href="../viewcustumers.php">View allCustumer</a></li>
                                <li><a href="../nr.php">Noreplyfromwash</a></li>
                           <li><a href="../nc.php">Custumers NotConfirmed</a></li>
 <li><a href="../cc.php">Custumers Confirmed</a></li>
 <li><a href="../del.php">Custumers Delivered</a></li>
...
<form action="invoice.php" METHOD="post">
      	<div class='row'>
      		<div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
      			<div class="form-group">
					<input type="text" class="form-control" id="clientCompanyName" placeholder="Custumer Name" name="cn"  required="true">
				</div>
				<div class="form-group">
					<textarea class="form-control" rows='3' id="clientAddress" placeholder="Your Address" name="address" required="true"></textarea>
				</div>
				<div class="form-group">
					<input type="email" class="form-control" id="clientCompanyName" placeholder="Email" name="email" required="true">
				</div>
      		...
      		<div class='col-xs-12 col-sm-offset-3 col-md-offset-3 col-lg-offset-3 col-sm-4 col-md-4 col-lg-4'>
				...
				<div class="form-group">
					<input type="text" class="form-control amountDue"  placeholder="Mobile" name="mobile" required="true"> 
				</div>
<div class="form-group">
