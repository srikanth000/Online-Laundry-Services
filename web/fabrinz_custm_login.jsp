	...
	<div class='loginwrap'>
		...
		<div class='login'>
                    ...
                    <div class='loginhead'>
                            ...
                            <form method='post' action='login_custm.jsp' name="fabrinz_login" id="fabrinz_login">
                                    <input type='text' placeholder='Email/Mobile No' name="email1" id="uname" />
					...
					<a href='Sign-up.jsp' class='blk'>Not a Customer?   Sign Up</a>
                                        <a href='fabrinz_custm_forgot.jsp' class='blk'>Forgot Password</a>
