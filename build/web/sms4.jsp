...
String message1="WelCome to Fabrinz. Your Order is ready to dispatch."+"\n"+"Store Name:"+ session.getAttribute("store_name")+"\n"+"OrderId:"+ session.getAttribute("sorderid")+"\n"+"Amount:"+session.getAttribute("stamount")+"";
