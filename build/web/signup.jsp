...
<body background="bg/03.jpg">
    
<div id="form">
  <div class="container">
    <center> <a href="index.jsp"><img src='img/logologin.png' align='center' style="margin-top: 20px;width:220px;height:110px"/></a>
      ...
      <div id="userform">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade  active  in" id="login">
            ...
            <form action="login_custm.jsp" method="post" id="login" name="login" onSubmit="return formValidation()">
              ...
              <div class="form-group">
                ...
                <span style="color:red" class="help-block text-danger" id="p1"></span>
              </div>
              <div class="mrgn-30-top">
				...
				<span style="color:red" class="help-block text-danger" id="s1"></span>
                                <a href='signup.jsp' style="color:white; font-weight: bold; float:right; " class='blk'>Not a Customer?   Sign Up</a>
                                        <a href='Nforgot.jsp' class='blk' style="color:white; font-weight: bold; float:left">Forgot Password</a>
