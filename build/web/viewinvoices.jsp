...
<%
    ...
    int tqty=0; 
    int tamount=0; 
ResultSet rs=st.executeQuery("select * from orderlist where sid='"+session.getAttribute("uid")+"' and orderstatus='Complete'");
while(rs.next())
{ tqty=tqty+ rs.getInt("tqty");
tamount=tamount+ rs.getInt("tamount");
                                ...
                                <tr>
                                    ...
                                    <td><%=rs.getString("custname")%></td>
                                     <td><%=rs.getString("tqty")%></td>
                                      ...
                                      <td><%=rs.getString("paystatus")%> </td> 
                                      <td><a href="viewinvoice.jsp?orderid=<%=orderid%>">Print Invoice</a> </td>  
...
<table border="1px" style="margin-top:15px;">
  <tr>
      <td>Total Amount : &nbsp;<%=tamount%></td>
    <td>Total Quantity : &nbsp;<%=tqty%> </td>
