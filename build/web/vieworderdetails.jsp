...
{
%>
<h2 align="right">Order Date : &nbsp; <%=rs.getString("orderdate")%> &nbsp; &nbsp;</h2>
...
<tr>
    ...
    <td><a href="orderreceipt.jsp?orderid=<%=orderid%>"><input type="button" name="print" value="Print"/></a></td>
...
<div id="update" style="width: 90%; height: auto; margin-left: 5%; margin-right: 5%; display: none;">
    <form method="post" action="update_order_status.jsp?orderid=<%=orderid%>">            
<%
...
%> 
                                   ...
                                   <table width="100%" border="1px" id="myTable" class="tablesorter" >
                                    ...
                                    <td >Order Status : 
                                     ...
                                     <td >Payment Status : <%=rs3.getString("paystatus")%></td>
                                      </tr>
