<%-- 
    Document   : sms
    Created on : Jun 10, 2017, 11:45:28 AM
    Author     : shekhar
--%>
...
<%
    ...
    String paystatus="paid thorugh online";
  int j=st.executeUpdate("update orderlist SET  paystatus='"+paystatus+"'  WHERE orderid='"+session.getAttribute("orderid")+"' ");
...
String mobile = (String)session.getAttribute("omobile");
...
String message1="WelCome to Fabrinz. Your order is successfully placed "+"\n"+"Details:"+"\n"+"Mobile:"+ session.getAttribute("Mobile")+"\n"+"OrderId:"+ session.getAttribute("orderid")+"\n"+"Amount:"+session.getAttribute("amount")+" Recieved thorugh Online"+"\n"+"PickUp time:"+session.getAttribute("pickup")+"\n";
