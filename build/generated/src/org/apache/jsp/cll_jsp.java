...
public final class cll_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!--?php\n");
      out.write("$i=1;\n");
      out.write("$sql=mysql_query(\"select * from invoice_list where user_id='\".$_SESSION['user'].\"'and confirm_status=1 ORDER BY delivery_date ASC\");\n");
      ...
      out.write("                                      <td><!--?php echo $row['delivery_date'];?--></td>\n");
